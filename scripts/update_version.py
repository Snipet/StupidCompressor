...
def main():
  ...
  plistpath = scriptpath + "/resources/StupidCompressor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StupidCompressor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StupidCompressor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StupidCompressor-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/StupidCompressor-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/StupidCompressor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/StupidCompressor.iss",inplace=1):
