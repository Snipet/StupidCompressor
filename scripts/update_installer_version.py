...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=StupidCompressor Demo Installer\n"
      else:
        line="OutputBaseFilename=StupidCompressor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the StupidCompressor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the StupidCompressor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=StupidCompressor Demo installer\n"
     else:
       line="SetupWindowTitle=StupidCompressor installer\n"
