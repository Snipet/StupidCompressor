...
Name: "{cf64}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Attribs: readonly; Check: Is64BitInstallMode; Components:aax_64; 
Name: "{cf32}\VST3\StupidCompressor.vst3\"; Attribs: readonly; Components:vst3_32; 
Name: "{cf64}\VST3\StupidCompressor.vst3\"; Attribs: readonly; Check: Is64BitInstallMode; Components:vst3_64; 

[Files]
Source: "..\build-win\StupidCompressor_Win32.exe"; DestDir: "{app}"; Check: not Is64BitInstallMode; Components:app; Flags: ignoreversion;
Source: "..\build-win\StupidCompressor_x64.exe"; DestDir: "{app}"; Check: Is64BitInstallMode; Components:app; Flags: ignoreversion;

Source: "..\build-win\StupidCompressor_Win32.dll"; DestDir: {code:GetVST2Dir_32}; Check: not Is64BitInstallMode; Components:vst2_32; Flags: ignoreversion;
Source: "..\build-win\StupidCompressor_Win32.dll"; DestDir: {code:GetVST2Dir_32}; Check: Is64BitInstallMode; Components:vst2_32; Flags: ignoreversion;
Source: "..\build-win\StupidCompressor_x64.dll"; DestDir: {code:GetVST2Dir_64}; Check: Is64BitInstallMode; Components:vst2_64; Flags: ignoreversion;

Source: "..\build-win\StupidCompressor.vst3\*.*"; Excludes: "\Contents\x86_64\*,*.pdb,*.exp,*.lib,*.ilk,*.ico,*.ini"; DestDir: "{cf32}\VST3\StupidCompressor.vst3\"; Components:vst3_32; Flags: ignoreversion recursesubdirs;
Source: "..\build-win\StupidCompressor.vst3\Desktop.ini"; DestDir: "{cf32}\VST3\StupidCompressor.vst3\"; Components:vst3_32; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
Source: "..\build-win\StupidCompressor.vst3\PlugIn.ico"; DestDir: "{cf32}\VST3\StupidCompressor.vst3\"; Components:vst3_32; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
...
; Source: "..\build-win\aax\bin\StupidCompressor.aaxplugin\*.*"; Excludes: "\Contents\x64\*,*.pdb,*.exp,*.lib,*.ilk,*.ico,*.ini"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Components:aax_32; Flags: ignoreversion recursesubdirs;
; Source: "..\build-win\aax\bin\StupidCompressor.aaxplugin\Desktop.ini"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Components:aax_32; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
; Source: "..\build-win\aax\bin\StupidCompressor.aaxplugin\PlugIn.ico"; DestDir: "{cf32}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Components:aax_32; Flags: overwritereadonly ignoreversion; Attribs: hidden system;

Source: "..\build-win\StupidCompressor.aaxplugin\*.*"; Excludes: "\Contents\Win32\*,*.pdb,*.exp,*.lib,*.ilk,*.ico,*.ini"; DestDir: "{cf64}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Check: Is64BitInstallMode; Components:aax_64; Flags: ignoreversion recursesubdirs;
Source: "..\build-win\StupidCompressor.aaxplugin\Desktop.ini"; DestDir: "{cf64}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Check: Is64BitInstallMode; Components:aax_64; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
Source: "..\build-win\StupidCompressor.aaxplugin\PlugIn.ico"; DestDir: "{cf64}\Avid\Audio\Plug-Ins\StupidCompressor.aaxplugin\"; Check: Is64BitInstallMode; Components:aax_64; Flags: overwritereadonly ignoreversion; Attribs: hidden system;
